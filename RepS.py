...
parser.add_argument('source folder', type=str, help='path to folder of replays')
parser.add_argument('-s', '--sort', type=str, choices=['p','m'], required=True, help='sort replays by player name (p) or by matchup (m)')
parser.add_argument('-t', '--target', type=str, help='destination folder for the replays')
